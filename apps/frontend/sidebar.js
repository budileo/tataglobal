(function() {
  ...
  // Deteksi modul aktif berdasarkan nama file dashboard saat ini secara case-insensitive
  const pathLower = cleanPath.toLowerCase();
  if (pathLower === 'dasbort_finance.html' || pathLower === 'dasbort_finance') {
    activeModule = 'finance';
    localStorage.setItem('active_module', 'finance');
  } else if (pathLower === 'dasbort_marketing.html' || pathLower === 'dasbort_marketing') {
    activeModule = 'marketing';
    localStorage.setItem('active_module', 'marketing');
  } else if (pathLower === 'dashboard.html' || pathLower === 'dashboard') {
    activeModule = 'operasional';
    localStorage.setItem('active_module', 'operasional');
  } else if (pathLower === 'dasbort_hrd.html' || pathLower === 'dasbort_hrd') {
    activeModule = 'hrd';
    localStorage.setItem('active_module', 'hrd');
  } else if (pathLower === 'setting.html' || pathLower === 'setting') {
  ...
  // Tentukan menu aktif berdasarkan modul yang terdeteksi
  ...
  const renderSidebar = () => {
    ...
    activeMenus.forEach(item => {
      // Pengecekan status aktif secara fleksibel
      const pathPart = cleanPath.toLowerCase();
      const hrefPart = item.href.toLowerCase();
